...
public class DocumentShortcutSerDes {
	...
	public static String toJSON(DocumentShortcut documentShortcut) {
		...
		if (documentShortcut.getCreator() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(documentShortcut.getCreator()));
		}
		...
		if (documentShortcut.getReferencedDocument() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(documentShortcut.getReferencedDocument()));
		}
	...
	public static Map<String, String> toMap(DocumentShortcut documentShortcut) {
		...
		if (documentShortcut.getCreator() == null) {
			...
			map.put("creator", String.valueOf(documentShortcut.getCreator()));
		}
		...
		if (documentShortcut.getReferencedDocument() == null) {
			map.put("referencedDocument", null);
		}
		else {
			map.put(
				"referencedDocument",
				String.valueOf(documentShortcut.getReferencedDocument()));
		}
			...
			if (Objects.equals(jsonParserFieldName, "creator")) {
				...
				if (jsonParserFieldValue != null) {
					documentShortcut.setId(
						...
						jsonParserFieldName, "referencedDocument")) {

				if (jsonParserFieldValue != null) {
					documentShortcut.setReferencedDocument(
