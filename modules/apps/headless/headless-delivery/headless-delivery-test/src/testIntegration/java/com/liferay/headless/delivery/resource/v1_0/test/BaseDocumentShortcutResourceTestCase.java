...
public abstract class BaseDocumentShortcutResourceTestCase {
	...
	protected void assertValid(DocumentShortcut documentShortcut)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"referencedDocument", additionalAssertFieldName)) {
	...
	protected boolean equals(
		...
		if (!Objects.equals(
				documentShortcut1.getSiteId(), documentShortcut2.getSiteId())) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("creator", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentShortcut1.getCreator(),
						documentShortcut2.getCreator())) {
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						documentShortcut1.getReferencedDocument(),
						documentShortcut2.getReferencedDocument())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("referencedDocument")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
