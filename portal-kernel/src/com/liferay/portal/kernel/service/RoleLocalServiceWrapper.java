...
public class RoleLocalServiceWrapper implements RoleLocalService,
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.portal.kernel.model.Role> getGroupRolesAndTeamRolesByRoleId(
		long companyId, java.lang.String keywords,
		java.util.List<java.lang.String> excludedNames, int[] types,
		long excludedTeamRoleId, long teamGroupId, long[] roleIds, int start,
		int end) throws com.liferay.portal.kernel.exception.PortalException {
		return _roleLocalService.getGroupRolesAndTeamRolesByRoleId(companyId,
			keywords, excludedNames, types, excludedTeamRoleId, teamGroupId,
			roleIds, start, end);
	}
